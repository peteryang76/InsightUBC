...
export default class Server {
	...
	private static async performPUT(id: string, kind: string, zip: any): Promise<any> {
		let facade = new InsightFacade();
		if (kind === "courses") {
			return await facade.addDataset(id, zip, InsightDatasetKind.Courses);
		} else if (kind === "rooms") {
			return await facade.addDataset(id, zip, InsightDatasetKind.Rooms);
		} else {
	...
	private static async performDataset(id: string): Promise<any> {
		let facade = new InsightFacade();
	...
	private static async performQuery(query: any) {
		let facade = new InsightFacade();
	...
	private static async performList(): Promise<InsightDataset[]> {
		let facade = new InsightFacade();
